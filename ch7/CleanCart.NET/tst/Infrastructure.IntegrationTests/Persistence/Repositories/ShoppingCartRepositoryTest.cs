...
public class ShoppingCartRepositoryTest(TestInitializer testInitializer) : IAsyncLifetime
{
    ...
    private ShoppingCartRepository Sut => new(_dbContextFactory, _mapper);
